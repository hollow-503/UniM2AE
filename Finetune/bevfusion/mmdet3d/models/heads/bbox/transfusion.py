...
class TransFusionHead(nn.Module):
    def __init__(
        ...
        # self.weather_encoding = nn.Conv1d(4, hidden_channel, 1)
    ...
    def forward_single(self, inputs, img_inputs, metas):
        ...
        # print(weather_np)
        # weather_tensor = torch.tensor(weather_np)[None, :]
        # weather_tensor = weather_tensor.repeat(one_hot.shape[-1], 1).permute(1, 0)[None, :]
        # print('================================')
        # print(weather_tensor)
        # print(weather_tensor.shape)
        # print(type(weather_tensor))
        # print('================================')
        # query_wea_encoding = self.weather_encoding(weather_tensor.float().to(query_cat_encoding.device))
        query_feat += query_cat_encoding
        # query_feat += query_wea_encoding
